...
void menu_init(void)
{
    ...
    MenuItem *numeric_item = create_menu_item("Value", MENU_ITEM_NUMERIC, NULL, NULL);
    numeric_item->menu_item.numeric_item.value = &adc_value[0];
...
//    // 构建菜单层次结构
	...
	add_menu_item(&root_menu->menu_item.submenu, action_item2);
	add_menu_item(&root_menu->menu_item.submenu, action_item3);
	add_menu_item(&root_menu->menu_item.submenu, action_item4);
//	add_menu_item(&root_menu->menu_item.submenu, action_item5);
//		
